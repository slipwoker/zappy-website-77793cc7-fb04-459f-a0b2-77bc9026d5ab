...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('minlength') && value.length < parseInt(input.getAttribute('minlength'))) {
                showError(input, fieldName + ' must be at least ' + input.getAttribute('minlength') + ' characters');
                return false;
            }
    ...
    document.querySelectorAll('.fade-in, .animate-on-scroll, [data-animate]').forEach(function(element) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '77793cc7-fb04-459f-a0b2-77bc9026d5ab',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '77793cc7-fb04-459f-a0b2-77bc9026d5ab';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '77793cc7-fb04-459f-a0b2-77bc9026d5ab';
